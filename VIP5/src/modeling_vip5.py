...
# Transformers version compatibility fix
try:
    # For transformers <= 4.21.x
    from transformers.models.t5.modeling_t5 import (
        T5LayerNorm, T5DenseReluDense, T5DenseGatedGeluDense, 
        T5PreTrainedModel, T5ForConditionalGeneration
    )
except ImportError:
    # For transformers >= 4.22.0, classes were renamed
    from transformers.models.t5.modeling_t5 import (
        T5LayerNorm, 
        T5DenseActDense as T5DenseReluDense,
        T5DenseGatedActDense as T5DenseGatedGeluDense,
        T5PreTrainedModel, T5ForConditionalGeneration
    )
